...
export default function Cliente() {
  ...
  const pasos = [
    { 
      ...
      desc: "Se instaló el rol de servidor DHCP para automatizar la asignación de direcciones IP en la red del laboratorio. Tras finalizar la instalación, se ejecutó el asistente de configuración posterior para la autorización del servidor en AD DS.", 
    ...
    { 
      ...
      desc: "Se definió el rango de direcciones (192.168.10.50 a 192.168.10.100) y las opciones de red. Se asoció al dominio inacap.local con servidor DNS 192.168.10.10.", 
